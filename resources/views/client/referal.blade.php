                ...
                <div class="bg-light rounded p-3">
                    <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 185, 142, .3)">
                        <div class="row g-5 align-items-center">
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                            <div class="mb-4">
                                    <h4 class="mb-3">Why Join Sonawane's Circle of Trust</h4>
                                  <p><strong>Exclusive Rewards:</strong>Earn attractive rewards for every successful referral, making your journey with Sonawane Group even more rewarding.</p>
                                  <p><strong>Priority Access:</strong>Gain early access to our upcoming projects, special promotions, and exclusive events. Be the first to know about new opportunities in the real estate market.</p>
