        ...
        <div class="container-fluid header bg-white p-0"  style="margin-top:10px;width:100%">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                ...
                <div class="col-md-12 animated fadeIn">
                        ...
                        <img id="mobile" class="img-fluid" style="height:500px;width:100%" src="banner/mobile-1.jpg" alt="">
                            <img id="desktop" class="img-fluid" style="height:600px" src="banner/slide-1.jpg" alt="">
                        </div>
...
<div class="container">
    ...
    <h4>THE PRIDE OF KALYAN</h4>
    <p>
        Krishna Anand, a  thoroughly planned project within the vicinity of Kalyan East,  spreading across  2215 sq-m with 184 residential units. A dream home of 1 & 2 BHK that is earthquake proof, vastu compliant and amalgamated with luxury, comfort, ultra modern 30+ amenities, locational advantages and lifestyle conveniences.
        </p>
        </center>
        <div class="row me-3">
            <div class="col-md-6">
         ...
         src="images/head-icon-white.png"> -->
            ...
            <div class="row">
                <!--<div class="col-12" >-->
                    ...
                    <div class="col-md-4 col-12" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
                        <div class="config-wrap">
                            <h3><span>1 BHK JODI</span></h3>
                            <div class="config-line"></div>
                            <h2>828.62 <br>SQ.FT.<br></h2>
                            <div class="config-line"></div>
                            <button class="pricing_btn price-click">₹ Check Price</button>
                        </div>
                    </div>
...
<section class="glob-sec-bg grey-bg" id="location">
    <div class="overlay" style="background: #fff!important;">
        ...
        Yes! Finally, the home of your dreams is coming up right here in
        Kalyan. With ultramodern amenities, locational advantages and
        lifestyle conveniences, you can invite guests with pride.
                    </p>
            <div class="row mt-5">
            <div class="col-md-6 ">
    ...
    <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">
          ...
          <p>ICICI BANK - 1.5 km</p>
            ...
            <div class="col-md-6">
                    <a data-fancybox="general" href="assets/krishna/images/gallery/location/1.jpg" class="l-box">
                        <img src="assets/krishna/images/gallery/location/1.jpg" width="100%">
